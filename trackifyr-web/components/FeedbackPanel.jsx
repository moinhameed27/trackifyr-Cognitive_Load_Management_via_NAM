/**
 * @fileoverview FeedbackPanel component - displays AI-powered feedback messages
 * with different types (warning, info, success).
...
import { feedbackMessages } from '@/data/cognitiveLoadData'
  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100 p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-xl font-bold text-gray-900">Feedback & Recommendations</h2>
          ...
          return (
            ...
            >
              <div className="flex items-start space-x-3">
                <div className={`p-2 rounded-lg ${config.iconBg} ${config.text} flex-shrink-0`}>
                  {config.icon}
                </div>
